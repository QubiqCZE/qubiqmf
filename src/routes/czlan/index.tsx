...
export const Route = createFileRoute('/czlan/')({
  component: CzlanPage,
})
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-400 text-lg leading-relaxed">
            Spolek zaměřený na komunitu, vzdělávání a kutilství. Tato stránka
            slouží jako výchozí místo pro přehled aktivit a projektových akcí.
          </p>
        </div>
        ...
        <section className="glass-card rounded-xl p-6">
          ...
          <p className="text-slate-300 mb-4">
            Kalendář akcí pro CZLAN najdeš v centrálním přehledu kalendářů.
          </p>
          <Link
            to="/events/"
